...
public class ZahtevParser {
    ...
    public static void main(String[] args) throws Exception {
        int code = 4666;
        List<String> list = ZahtevParser.make(code);
        ZahtevParser.save(conn = AuthenticationUtilities.loadProperties(), list.get(0), list.get(1), list.get(2));
    }
    ...
    public static ArrayList<String> make(int code) throws Exception {
        ...
        documentId = "zahtev_za_sertifikat-" + code + ".xml";
        filePath = "podaci/xml/zahtev_za_sertifikat.xml";
    ...
    public static void save(ConnectionProperties conn, String collectionId, String documentId, String filepath) throws Exception{
        ...
        ZahtevZaSertifikat zahtevZaSertifikat = unmarshall_2(context);
        marshall(res, context, zahtevZaSertifikat, os, col);
    }

    public static JAXBContext unmarshall_1() throws Exception{

        System.out.println("[INFO] Unmarshalling XML document to an JAXB instance: ");
        JAXBContext context = JAXBContext.newInstance("com.spring.rest.model.zahtev");
    ...
    public static ZahtevZaSertifikat unmarshall_2(JAXBContext context) throws Exception{
...
//        zahtevZaSertifikat.setMesto(new ZahtevZaSertifikat.Mesto(""))// Random name update for test
    ...
    public static void marshall(XMLResource res, JAXBContext context, ZahtevZaSertifikat zahtevZaSertifikat, OutputStream os, Collection col) throws Exception{
        Marshaller marshaller = context.createMarshaller();
        marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);

        // marshal the contents to an output stream
        marshaller.marshal(zahtevZaSertifikat, os);
