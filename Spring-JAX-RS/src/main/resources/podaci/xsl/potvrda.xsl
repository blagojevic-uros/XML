        ...
        <html>
            ...
            <body>
                ...
                <p style = "padding-top:10px">
                    Ime i prezime: <xsl:value-of select="//po:PunoIme/ct:Ime/text()"/> <xsl:value-of select="//po:LicneInformacije/po:PunoIme/ct:Prezime/text()"/>
                </p>
                ...
                <p style = "padding-top:10px;">
                    Pol: <xsl:value-of select="//po:Pol/text()"/>
                </p>

                <p style = "padding-top:10px;">
                    JMBG: <xsl:value-of select="//po:JMBG/text()"/>
                </p>

                <xsl:for-each select="//po:InformacijeOVakcinama">
                    <p style = "padding-top:10px;">
                        <!--Datum davanja <xsl:value-of select="po:TInfomacijeODozi/po:"/> doze i broj serije vakcine: <xsl:value-of select="concat(' ', po:DatumIzdavanja/text(), ' ', po:/text())"/>-->
                    </p>
                    <p style = "padding-top:10px;">
